...
export BLACKLIST=/titan/cancerregulome9/ITMI_PTB/public/analysis/blacklists/weightedBlacklist
export RFACEOPTIONS="-i N:CLIN:TermCategory:NB:::: -n 12800 -m 75 -a 1000 -s 1"
