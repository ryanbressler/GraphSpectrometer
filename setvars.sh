...
export GFOREST=/titan/cancerregulome9/ITMI_PTB/bin/go/src/github.com/ryanbressler/CloudForest/growforest/growforest
export BLACKLIST=/titan/cancerregulome9/ITMI_PTB/public/analysis/blacklists/ptbPlusTemplate.txt
